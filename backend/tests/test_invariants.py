...
def test_no_report_formula_codes_leaked_into_invariants_source() -> None:
    ...
    `reconcile_political_legislative_and_survival_report` in §9.3) — must never appear in `invariants.py`.
    ...
    for fragment in forbidden_code_fragments:
        assert fragment not in source, (
            ...
            "or reconcile_political_legislative_and_survival_report (§9.3), never to check_invariants"
        )
